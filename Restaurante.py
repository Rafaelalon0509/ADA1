...
class RestauranteApp(tk.Tk):
    def __init__(self):
        ...
        self.title("aplicación inventario")
        ...
        self.tabControl.add(self.tabOrdenes, text="ordenes")
    ...
    def asignar_turno(self):
        ...
        if turno:
            ...
            messagebox.showinfo("información", 
                                f"tturno {turno} asignado a {empleado}.")
        else:
    ...
    def create_historial_widgets(self):
        ...
        btn_deshacer_orden = tk.Button(frame_historial, text="deshacer ultima Orden", command=self.deshacer_ultima_orden)
