...
class RestauranteApp(tk.Tk):
    def __init__(self):
        ...
        self.title("aplicación de inventario ")
        style = ttk.Style()
        style.configure("TFrame", background="#40fd39")
        style.configure("TNotebook",background="#a239fd")
...
if __name__ == "__main__":
    app = RestauranteApp()
    app.iconbitmap("C:\\Users\\PC\\Downloads\\autobot.ico")
    app.mainloop()
